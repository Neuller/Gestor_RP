			...
			<tbody>
				...
				while ($mostrar = mysqli_fetch_array($result)) {
					...
					'
                        ...
                        <td>' . '<span class="btn btn-success btn-md" data-toggle="modal" data-target="#entregaRapida" title="ENTREGA RÁPIDA" onclick="entregaRapida('.$mostrar[0].', '.$mostrar[3].', '.$mostrar[2].')">
