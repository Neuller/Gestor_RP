...
WHERE status NOT LIKE 'ENTREGA REALIZADA'
...
<body>
	<div class="table-responsive">
		<table id="tblPedidosEstoque" class="table table-hover table-condensed table-bordered text-center table-striped">
			<thead>
				<tr>
					<td>CÓDIGO</td>
			...
			<tbody>
				...
				while ($mostrar = mysqli_fetch_array($result)) {
					...
					'
                        ...
                        <td>' . '<span class="btn btn-success btn-lg" data-toggle="modal" data-target="#entregarPedido" title="REALIZAR ENTREGA" onclick="entregarPedido('.$mostrar[0].')">
